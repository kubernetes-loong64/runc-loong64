...
Push a branch named `loong64-<runc-version>` (e.g. `loong64-v1.5.1`) to trigger a build. Append `+<build>`
(e.g. `loong64-v1.5.1+0`) to include build metadata.

## [Release](https://github.com/kubernetes-loong64/runc-loong64/releases)

Push a tag matching `release-loong64-<runc-version>` (e.g. `release-loong64-v1.5.1+0`) to publish
